		...
		<div className="container mt-4 mb-4 p-3 d-flex justify-content-center">
	    	<div className="profilecard p-4 col-md-3">
	        	<div className="profileimage d-flex flex-column justify-content-center align-items-center"> <button className="profilebtn btn-secondary"> <img src="https://i.imgur.com/wvxPV9S.png" height="100" width="100" /></button> <span className="name mt-3">Eleanor Pena</span> <span className="idd">@eleanorpena</span>
		            ...
		            <div className="d-flex flex-row justify-content-center align-items-center mt-3"> <span className="profilenumber">1069 <span className="profilefollow">Followers</span></span> </div>
		            <div className="d-flex flex-row justify-content-center align-items-center"> <span className="profilenumber">300 <span className="profilefollow">Following</span></span> </div>
